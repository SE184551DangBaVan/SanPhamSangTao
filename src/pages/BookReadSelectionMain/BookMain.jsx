    ...
    return (
        ...
        <main className='book-container' style={{right: `calc(-50% + ${scrollPageOffset/2}px)`}}>
            ...
            <article className="content">
                ...
                <div className="article-content">
                    <p><span className="first-letter">A</span>s digital news portals compete for reader attention, their typographic choices have become increasingly significant branding elements. The persistence of serif typefaces in digital news environments speaks to their enduring association with journalistic authority.</p>
