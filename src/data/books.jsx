...
export const book1Data = {
  ...
  paragraphs: [
    ...
    <p className="article-content"><span className="first-letter">B</span>ản sắc dân tộc và tiếp thu tinh hoa nhân loại: văn hóa dân tộc có giá trị to lớn, vừa giữ truyền thống vừa tiếp thu tinh hoa nhân loại – hợp thành nguyên tắc dân tộc – khoa học – đại chúng mà Hồ Chí Minh đề cao.</p>
  ],
  images: [
    Image2,
    Image1,
...
export const book2Data = {
  title: "Vai trò của văn hóa trong cách mạng và phát triển xã hội",
  paragraphs: [
...
export const book3Data = {
  ...
  paragraphs: [
    ...
    <p className="article-content"><span className="first-letter">T</span>hời kỳ xây dựng CNXH: văn hóa phải mang nội dung xã hội chủ nghĩa, gắn liền với tính dân tộc, khoa học, tiến bộ và nhân văn.</p>,
...
// Book 5: Vai trò văn hóa trong phát triển hiện đại
export const book5Data = {
  title: "Vai trò văn hóa trong phát triển hiện đại",
  paragraphs: [
...
// Book 6: Xây dựng con người Việt Nam hiện đại theo tư tưởng Hồ Chí Minh
export const book6Data = {
  title: "Xây dựng con người Việt Nam hiện đại theo tư tưởng Hồ Chí Minh",
  paragraphs: [
